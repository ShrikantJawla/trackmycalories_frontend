...
export const macroTargets = (foodItemsInList, energyPer) => {
    if (foodItemsInList) var { main, Fat } = data(foodItemsInList)
    let targets = [
        { title: 'Energy', value: energyPer },
